...
? 'F7  = update the screen with current Estonian code'
? 'F8  = update the screen with current common code'
? 'F12 = accept mapping from NCSP common version to NCSP Estonian version'
? 'F11 = accept mapping from NCSP Estonian version to NCSP common version'
