...
? 'F7  = update the screen with current English code'
? 'F8  = update the screen with current common code'
? 'F12 = accept mapping from NCSP common version to NCSP English version'
? 'F11 = accept mapping from NCSP English version to NCSP common version'
