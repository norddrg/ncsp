...
do while sl_loop
  ...
  if sl_kier=1
    ...
    if not found()
      ...
      ncsp_en.reldate:6:r, ncsp_en.subst:6:r, code_den, code_swe, code_est, code_nor, code_fin save nomodify nowait
      ...
      do while found()
        ...
        ncsp_en.chadate:6 :r, ncsp_en.usedate:6:r, ;
        ncsp_en.reldate:6:r, ncsp_en.subst:6:r, code_den, code_swe, code_est, code_nor, code_fin save nomodify nowait
        wait window 'Local code '+trim(sl_code)+' not found in local version - delete from combined table? Y/N'
        if lastkey()=89 or lastkey()=121 
          replace ncsp_en.code_eng with ' '
        else
          return
  ...
  if sl_kier=2
    ...
    skip
    if code_eng=sl_code and sl_code=code_eng
      select ncsp_koo
      browse window koodit fields ncsp_koo.released:2:r, ncsp_koo.code:7, ncsp_koo.text:50, ncsp_koo.short:20,;
      ncsp_koo.ncsp:9, ncsp_koo.chadate:6 :r, ncsp_koo.usedate:6:r, ;
      ncsp_koo.reldate:6:r, ncsp_koo.english:50 nowait save nomodify
