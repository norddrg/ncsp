...
procedure nayt_su
  lc_alias=alias()
  if alias()='SUOD'
    pub_code=substr(ncsp_koo.ncsp,1,4)
  else
...
if not (lc_alias = 'NCSP_KOO' or lc_alias = 'SUOD')
  ...
  seek trim(pub_code)
  browse window koodit fields ncsp_koo.released:2:r, ncsp_koo.code:8, ncsp_koo.text:50, ncsp_koo.short:20,;
  suod.old:7, suod.price:3, ncsp_koo.ncsp:9, suod.suod:2, ncsp_koo.chadate:6 :r, ncsp_koo.usedate:6:r, ;
  ncsp_koo.reldate:6:r, text_2:50, ncsp_koo.english:50 nowait save nomodify
endif
if lc_alias<>'NCSP_ALA'
  ...
  seek pub_code
  if not found() and lc_len>3
    lc_len=3
  endif
  set filter to substr(pub_code,1,lc_len)=substr(ncsp,1,lc_len) and not released
  browse window alaryh fields released:2:r, code:8, ncsp:7, text:50, short:20, suod.suod:2,  chadate:6 :r,; 
  usedate:6:r, reldate:6:r, text_2:50, english:50 nowait save nomodify
endif
if lc_alias<>'NCSP_RYH'
  ...
  browse window ryhmat fields released:2:r, code:8, ncsp:7, text:50, short:20, suod.suod:2,  chadate:6 :r,; 
  usedate:6:r, reldate:6:r, text_2:50, english:50 nowait save nomodify
endif
if lc_alias<>'NCSP_LUV'
  ...
  browse window luvut fields released:2:r, code:8, ncsp:7, text:50, short:20, suod.suod:2,  chadate:6 :r,; 
  usedate:6:r, reldate:6:r, text_2:50, english:50 nowait save nomodify
endif
do CASE
...
if not (lc_alias='NCSP_KOO' or lc_alias='SUOD')
  ...
  suod.old:7, suod.price:3, ncsp_koo.ncsp:7, suod.suod:2, ncsp_koo.chadate:6 :r, ncsp_koo.usedate:6:r, ;
...
if lc_alias<>'NCSP_ALA'
  ...
  browse window alaryh fields released:2:r, code:7, ncsp:7, text_2:50, short:20, suod.suod:2,  chadate:6 :r,; 
...
if lc_alias<>'NCSP_RYH'
  ...
  browse window ryhmat fields released:2:r, code:7, ncsp:7, text_2:50, short:20, suod.suod:2,  chadate:6 :r,; 
  usedate:6:r, reldate:6:r, english:50 nowait save nomodify
endif
if lc_alias<>'NCSP_LUV'
  select ncsp_luv
  ...
  browse window luvut fields released:2:r, code:7, ncsp:7, text_2:50, short:20, suod.suod:2,  chadate:6 :r,; 
  usedate:6:r, reldate:6:r, english:50 nowait save nomodify
endif
do CASE
case lc_alias='NCSP_LUV'
