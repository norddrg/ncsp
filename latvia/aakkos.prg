...
do while not eof()
  do sanotus with code, text, 'Eng', ncsp, 'LUV'
  select ncsp_luv
  do sanotus with code, text_2, 'Ice', ncsp, 'LUV'
  select ncsp_luv
  skip
enddo
select ncsp_ryh
...
do while not eof()
  do sanotus with code, text, 'Eng', ncsp, 'RYH'
  select ncsp_ryh
  do sanotus with code, text_2, 'Ice', ncsp, 'RYH'
  select ncsp_ryh
  skip
enddo
select ncsp_ala
...
do while not eof()
  ...
  do sanotus with code, text, 'Eng', ncsp, 'ALA'
  select ncsp_ala
  do sanotus with code, text_2, 'Ice', ncsp, 'ALA'
  select ncsp_ala
  skip
enddo
select ncsp_koo
...
do while not eof()
  ...
  do sanotus with code, text, 'Eng', ncsp, ' '
  select ncsp_koo
  do sanotus with code, text_2, 'Ice', ncsp, ' '
  select ncsp_koo
  skip
enddo
do _ncsp
