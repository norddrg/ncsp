procedure naytto 
  ...
  select 0
  use ..\muisti
  replace muisti.ncsp with ncsp_koo.code
  p_ncsp=ncsp
  use
  return
...
procedure nayt_su
  lc_alias=alias()
  if alias()='SUOD'
    pub_code=substr(ncsp_koo.code,1,3)
  else
...
case lc_alias='NCSP_LUV'
  ...
  browse window luvut fields released:2:r, code:8, text:50, short:20, suod.suod:2,  chadate:6 :r,; 
...
case lc_alias='NCSP_RYH'
  ...
  browse window ryhmat fields released:2:r, code:8, text:50, short:20, suod.suod:2,  chadate:6 :r,; 
  usedate:6:r, reldate:6:r, text_2:50, english:50 nowait save nomodify
case lc_alias='NCSP_ALA'
  ...
  browse window alaryh fields released:2:r, code:8, text:50, short:20, suod.suod:2,  chadate:6 :r,; 
  usedate:6:r, reldate:6:r, text_2:50, english:50 nowait save nomodify
