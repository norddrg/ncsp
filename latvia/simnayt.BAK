...
? 'F12 = accept mapping from NCSP+ to NCSP Icelandic version'
? 'F11 = accept mapping from NCSP Icelandic version to NCSP+'
...
set filter to reldate=ctod(space(8))
set order to code
browse window codes fields ncsp_en.ncsp:9, ncsp_en.nc:2, ncsp_en.code_ice:8, ncsp_en.text:50,;
ncsp_en.chadate:6 :r, ncsp_en.usedate:6:r, ;
ncsp_en.reldate:6:r, ncsp_en.subst:6:r, code_den, code_fin, code_eng, code_nor, code_swe save nomodify nowait
return