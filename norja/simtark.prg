procedure simtark
  ...
  if found()
    lc_find=.t.
    if ncsp_en.code_nor<>ncsp_koo.code
      lc_tark=.t.
      if ncsp_en.code_nor=' ' and ncsp_en.ncsp=ncsp_koo.ncsp
    ...
    do while lc_loop 
      ...
      if eof() 
        ...
        if ncsp_en.code_nor<>ncsp_koo.code 
          ...
          if ncsp_en.code_den=' ' and ncsp_en.code_swe=' ' and ncsp_en.code_fin=' ' and code_est=' ' and code_eng=' ' and ncsp= ' '
