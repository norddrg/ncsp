...
? 'F7  = update the screen with current Swedish code'
? 'F8  = update the screen with current common code'
? 'F12 = accept mapping from NCSP common version to NCSP Swedish version'
? 'F11 = accept mapping from NCSP Swedish version to NCSP common version'
...
ncsp_en.reldate:6:r, ncsp_en.subst:6:r, code_den, code_fin, code_eng, code_nor, code_est save nomodify nowait
return