...
do while sl_loop
  ...
  if code_fin=' ' and code_nor=' ' and code_den=' ' and code_est=' ' and code_swe=' ' and code_eng=' ' and code_ice=' ' and ncsp= ' '
    delete
    skip 
    loop
  endif
  ...
  if sl_kier=1
    ...
    if not found()
      ...
      ncsp_en.reldate:6:r, ncsp_en.subst:6:r, code_den, code_eng, code_est, code_nor, code_fin save nomodify nowait
  ...
  if sl_kier=2
    ...
    skip
    if code_swe=sl_code and sl_code=code_swe
      select ncsp_koo
      browse window koodit fields ncsp_koo.released:2:r, ncsp_koo.code:7, ncsp_koo.text:50, ncsp_koo.short:20,;
      ncsp_koo.ncsp:9, ncsp_koo.chadate:6 :r, ncsp_koo.usedate:6:r, ;
      ncsp_koo.reldate:6:r, ncsp_koo.english:50 nowait save nomodify
      ...
      if code_swe=' ' and code_nor=' ' and code_den=' ' and code_est=' ' and code_fin=' ' and code_eng=' ' and code_ice=' ' and ncsp= ' '
        delete
      endif
      seek sl_code
      loop
