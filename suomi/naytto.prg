...
if lc_alias<>'NCSP_ALA'
  ...
  browse window alaryh fields released:2:r, code:7, ncsp:7, text:50, short:20, suod.suod:2,  chadate:6 :r,; 
...
if lc_alias<>'NCSP_RYH'
  ...
  browse window ryhmat fields released:2:r, code:7, ncsp:7, text:50, short:20, suod.suod:2,  chadate:6 :r,; 
  usedate:6:r, reldate:6:r, english:50 nowait save nomodify
endif
if lc_alias<>'NCSP_LUV'
  ...
  browse window luvut fields released:2:r, code:7, ncsp:7, text:50, short:20, suod.suod:2,  chadate:6 :r,; 
  usedate:6:r, reldate:6:r, english:50 nowait save nomodify
endif
do CASE
