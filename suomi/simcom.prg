...
? 'F7  = update the screen with current Finish code'
? 'F8  = update the screen with current common code'
? 'F12 = accept mapping from NCSP common version to NCSP Finish version'
? 'F11 = accept mapping from NCSP Finish version to NCSP common version'
...
set order to ncsp
seek ncsp_en.ncsp
browse window koodit fields ncsp_koo.released:2:r, ncsp_koo.code:7, ncsp_koo.english:50, ncsp_koo.short:20,;
...
ncsp_en.reldate:6:r, ncsp_en.subst:6:r, code_den, code_eng, code_est, code_nor, code_swe save nomodify nowait
return