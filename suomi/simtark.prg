procedure simtark
  ...
  if found()
    ...
    if ncsp_en.code_fin<>ncsp_koo.code
      lc_tark=.t.
      if ncsp_en.code_fin=' ' and ncsp_en.ncsp=ncsp_koo.ncsp
    ...
    do while lc_loop 
      ...
      if eof() 
        ...
        if ncsp_en.code_fin<>ncsp_koo.code 
          ...
          if ncsp_en.code_den=' ' and ncsp_en.code_swe=' ' and ncsp_en.code_nor=' ' and ncsp_en.code_est=' ' and ncsp_en.code_ice=' ' and ncsp_en.code_eng=' ' and ncsp_en.ncsp= ' '
