...
? 'F7  = update the screen with current Danish code'
? 'F8  = update the screen with current common code'
? 'F12 = accept mapping from NCSP common version to NCSP Danish version'
? 'F11 = accept mapping from NCSP Danish version to NCSP common version'
...
ncsp_en.reldate:6:r, ncsp_en.subst:6:r, code_fin, code_est, code_nor, code_swe, code_eng save nomodify nowait
return