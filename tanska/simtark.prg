procedure simtark
  ...
  if found()
    ...
    if ncsp_en.code_den<>ncsp_koo.code
      lc_tark=.t.
      if ncsp_en.code_den=' ' and ncsp_en.ncsp=ncsp_koo.ncsp
    ...
    do while lc_loop 
      ...
      if eof() 
        ...
        if ncsp_en.code_swe<>ncsp_koo.code 
          ...
          if ncsp_en.code_swe=' ' and ncsp_en.code_nor=' ' and ncsp_en.code_fin=' ' and code_est=' ' and code_eng=' ' and ncsp= ' '
  ...
  if not lc_find
    ...
    if found() 
      if ncsp_en.code_den<>ncsp_koo.code
        insert into ncsp_en (code, code_den, released, usedate, chadate, text);
